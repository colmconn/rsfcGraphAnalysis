...
./02-makeNuisanceMasks.sh -s 126_A
...
/home/colmconn/bin/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/126_A/126_Afuncon+orig \
	-script 126_A.rsfc.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/126_A/rsfcPreprocessed \
	-prefix 126_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
cd rsfcPreprocessed
tcsh -f 126_A.rsfc.preproc.tcsh
