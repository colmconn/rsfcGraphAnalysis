...
./02-makeNuisanceMasks.sh -s 145_A
...
/home/colmconn/bin/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/145_A/145_Afuncon+orig \
	-script 145_A.rsfc.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/145_A/rsfcPreprocessed \
	-prefix 145_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
cd rsfcPreprocessed
tcsh -f 145_A.rsfc.preproc.tcsh
