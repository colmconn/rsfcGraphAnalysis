...
./02-makeNuisanceMasks-tiff.sh -s 150_A
...
/data/sanDiego/rsfcGraphAnalysis/scripts/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/150_A/150_AESTOP+orig \
	-script 150_A.estop.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/150_A/estopPreprocessed \
	-prefix 150_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
tcsh -f 150_A.estop.preproc.tcsh
