...
./02-makeNuisanceMasks.sh -s 386_A
...
/home/colmconn/bin/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/386_A/386_Afuncon+orig \
	-script 386_A.rsfc.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/386_A/rsfcPreprocessed \
	-prefix 386_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
cd rsfcPreprocessed
tcsh -f 386_A.rsfc.preproc.tcsh
