...
./02-makeNuisanceMasks.sh -s 374_A
...
/home/colmconn/bin/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/374_A/374_Afuncon+orig \
	-script 374_A.rsfc.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/374_A/rsfcPreprocessed \
	-prefix 374_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
cd rsfcPreprocessed
tcsh -f 374_A.rsfc.preproc.tcsh
