...
./02-makeNuisanceMasks.sh -s 389_A
...
/home/colmconn/bin/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/389_A/389_Afuncon+orig \
	-script 389_A.rsfc.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/389_A/rsfcPreprocessed \
	-prefix 389_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
cd rsfcPreprocessed
tcsh -f 389_A.rsfc.preproc.tcsh
