...
./02-makeNuisanceMasks-tiff.sh -s 300_A
...
/data/sanDiego/rsfcGraphAnalysis/scripts/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/300_A/300_AESTOP+orig \
	-script 300_A.estop.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/300_A/estopPreprocessed \
	-prefix 300_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
tcsh -f 300_A.estop.preproc.tcsh
