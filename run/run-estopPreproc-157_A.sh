...
./02-makeNuisanceMasks-tiff.sh -s 157_A
...
/data/sanDiego/rsfcGraphAnalysis/scripts/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/157_A/157_AESTOP+orig \
	-script 157_A.estop.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/157_A/estopPreprocessed \
	-prefix 157_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
tcsh -f 157_A.estop.preproc.tcsh
