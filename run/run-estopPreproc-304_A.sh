...
./02-makeNuisanceMasks-tiff.sh -s 304_A
...
/data/sanDiego/rsfcGraphAnalysis/scripts/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/304_A/304_AESTOP+orig \
	-script 304_A.estop.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/304_A/estopPreprocessed \
	-prefix 304_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
tcsh -f 304_A.estop.preproc.tcsh
