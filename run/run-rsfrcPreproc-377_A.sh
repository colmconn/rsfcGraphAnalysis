...
./02-makeNuisanceMasks.sh -s 377_A
...
/home/colmconn/bin/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/377_A/377_Afuncon+orig \
	-script 377_A.rsfc.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/377_A/rsfcPreprocessed \
	-prefix 377_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
cd rsfcPreprocessed
tcsh -f 377_A.rsfc.preproc.tcsh
