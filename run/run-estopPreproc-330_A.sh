...
./02-makeNuisanceMasks-tiff.sh -s 330_A
...
/data/sanDiego/rsfcGraphAnalysis/scripts/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/330_A/330_AESTOP+orig \
	-script 330_A.estop.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/330_A/estopPreprocessed \
	-prefix 330_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
tcsh -f 330_A.estop.preproc.tcsh
