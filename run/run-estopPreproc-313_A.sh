...
./02-makeNuisanceMasks-tiff.sh -s 313_A
...
/data/sanDiego/rsfcGraphAnalysis/scripts/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/313_A/313_AESTOP+orig \
	-script 313_A.estop.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/313_A/estopPreprocessed \
	-prefix 313_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
tcsh -f 313_A.estop.preproc.tcsh
