...
./02-makeNuisanceMasks-tiff.sh -s 142_A
...
/data/sanDiego/rsfcGraphAnalysis/scripts/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/142_A/142_AESTOP+orig \
	-script 142_A.estop.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/142_A/estopPreprocessed \
	-prefix 142_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
tcsh -f 142_A.estop.preproc.tcsh
