...
./02-makeNuisanceMasks.sh -s 401_A
...
/home/colmconn/bin/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/401_A/401_Afuncon+orig \
	-script 401_A.rsfc.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/401_A/rsfcPreprocessed \
	-prefix 401_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
cd rsfcPreprocessed
tcsh -f 401_A.rsfc.preproc.tcsh
