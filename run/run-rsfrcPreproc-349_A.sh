...
./02-makeNuisanceMasks.sh -s 349_A
...
/home/colmconn/bin/afni_restproc.py \
	...
	-epi  /data/sanDiego/rsfcGraphAnalysis/data/349_A/349_Afuncon+orig \
	-script 349_A.rsfc.preproc.tcsh \
	-dest /data/sanDiego/rsfcGraphAnalysis/data/349_A/rsfcPreprocessed \
	-prefix 349_A.pm \
	-despike on \
	-anat_has_skull no \
	-tsnr \
...
cd rsfcPreprocessed
tcsh -f 349_A.rsfc.preproc.tcsh
